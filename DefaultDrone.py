...
def vCapture(VidPipePath, parent_pipe):
	...
	while not commitsuicideV:
		...
		tlag =				time.time()-declag
                small = cv2.resize(image, (0,0), fx=0.5, fy=0.8)
                cv2.imwrite("img.png", small)
...
def findOrange(img):
    ...
    for x in range (0,50):
        for y in range (0,height):
            ...
            if r > 60 and r < 145 and g > 160 and g < 240 and b > 40 and b < 115:
    ...
    #print "In orange"
    return mostOrange, orangeCount, foundGreen
...
def findYellow(img):
    ...
    for x in range (0,width/3):
        for y in range (0,height/3):
            r, g, b = img.getpixel((x,y))
            if r > 170 and r < 240 and g > 170 and g < 210 and b > 105 and b < 200:
                currentTally = currentTally + 1
            ...
            try:
                if done == True:
                    ...
                    if takeOff == True:
                            ...
                            drone.hover()
                    if ground == False:
                            command, orangeCount, foundGreen = findOrange(img)
                            width, height = img.size
                            totalPixels = (width*height)/3
                            print orangeCount
                            if orangeCount > 30:
                                firstGreenCheck = True
                                if command == 1:
                                    print "Turn Left"
                                    drone.turnAngle(-7,1)
                                elif command == 2:
                                ...
                                global foundGreen
                                foundgreen = False
                                if firstGreenCheck == False:
                                    drone.turnAngle(15,1)
                                else:
                                    ground = True
                                    drone.groundVideo(ground)
                                    drone.hover()
                        ...
                        command, yellowCount = findYellow(img)
                        width, height = img.size
                        totalPixels = (width*height)/3
                        print yellowCount
                        if yellowCount > 0:
