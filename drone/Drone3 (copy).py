...
def show_frame():
	...
	if centeredOverRedCircle == False:
		...
		print "Area in detect red: " + str(area)
		if cx != -1:
			...
			try:
				...
				# 	if cx > 250 and cx < 400 and cy > 85 and cy < 225:
				# 		print "In center"
				# 		drone.move(0.0,0.0,-0.4,0.0)
				# 		time.sleep(.25)
				# 		if area > 75000:
				# 			landing = True
				# 			drone.land()
				...
				if area > 18000 and cx > 200 and cx < 420 and cy > 60 and cy < 140:
					drone.move(0.0,0.0,-1.0,0.0)
					time.sleep(.5)
				
				else:

					if cy < 50 and cy > 0 and cx < 200:
						print "upper left"
						drone.move(-0.025,0.025,0.0,0.0)
						time.sleep(2)
						drone.stop()
						time.sleep(2)
					elif cy < 50 and cy > 0 and cx > 200 and cx < 440:
						print "upper center"
						drone.move(0.0,0.025,0.0,0.0)
						time.sleep(2)
						drone.stop()
						time.sleep(2)
					elif cy < 50 and cy >0 and cx > 440:
						print "upper right"
						drone.move(0.025,0.025,0.0,0.0)
						time.sleep(2)
						drone.stop()
						...
						print "lower right"
						drone.move(0.025,-0.025,-0.1,0.0)
						time.sleep(2)
						drone.stop()
						time.sleep(2)
					else:
