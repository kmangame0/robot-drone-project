...
path2 = 'savedinput'  #path of folder to save images    
...
im1 = array(Image.open('savedinput' + '/'+ imlist[0])) # open one image to get size
m,n = im1.shape[0:2] # get the size of the images
imnbr = len(imlist) # get the number of images

# create matrix to store all flattened images
immatrix = array([array(Image.open('savedinput'+ '/' + im2)).flatten()
              for im2 in imlist],'f')
...
#Changed above  input_shape=(1, img_rows, img_cols)))
...
# print score
# #Added this line:
# print "Printing elements in y_test"
# for y in y_test:
#     print y
